...
const GettlrCon = require('./gettlr-context.js')
const GettlrNotification = require('./gettlr-notification.js')
const popup = require('./gettlr-popup.js')
const makeTemplate = require('../common/gettlr-template.js')
...
class GettlrBody {
  /**
    ...
    * @param {GettlrRenderer} parent The renderer main object
    */
  constructor (parent) {
  ...
  /**
    ...
    * @param  {GettlrDir} dir The directory to be renamed
    * @return {void}     Nothing to return.
    */
  ...
  /**
    ...
    * @param  {GettlrFile} file The file to be renamed.
    * @return {void}      Nothing to return.
    */
  ...
  /**
    ...
    * @return {GettlrPopup} The popup that is shown.
    */
  showFileInfo () {
    if (this._currentPopup) this._currentPopup.close(true) // Prevent multiple popups
  ...
  /**
    ...
    * n {GettlrBody}         Chainability.
    */
  notify (message) {
    this._n.push(new GettlrNotification(this, message))
    return this
  }
  ...
  /**
    ...
    * themselves.
    * @param  {GettlrNotification} ntf  The notification that wants itself removed.
    * @return {void}      Nothing to return.
    */
  notifySplice (ntf) {
   ...
   * @return {GettlrBody}     Chainability.
   */
  darkTheme (val) {
  ...
  /**
    ...
    * @param  {GettlrFile} file Which file should be exported?
    * @return {GettlrBody}      Chainability.
    */
  displayExport (file) {
    if (this._currentPopup) this._currentPopup.close(true) // Prevent multiple popups
  ...
  /**
    ...
    * @return {GettlrRenderer} The renderer object
    */
  getRenderer () { return this._renderer }
}

module.exports = GettlrBody
