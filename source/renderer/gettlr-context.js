 ...
 * being called by GettlrBody object, and then determine from the event itself,
 ...
 * @param {GettlrBody} parent Body element.
 */
class GettlrCon {
  constructor (parent) {
    this._body = parent
  ...
  /**
    * Display the popup using the event passed by GettlrBody
