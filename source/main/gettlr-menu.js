...
class GettlrMenu {
  ...
  * @param {GettlrWindow} parent The main window.
  */
  constructor (parent) {
    this._window = parent
    // Load the blueprint
  ...
  _buildFromSource (menutpl) {
    ...
    if (menutpl.hasOwnProperty('label') && menutpl.label !== 'Gettlr') menu.label = trans(menutpl.label)
    if (menutpl.hasOwnProperty('label') && menutpl.label === 'Gettlr') menu.label = 'Gettlr'
